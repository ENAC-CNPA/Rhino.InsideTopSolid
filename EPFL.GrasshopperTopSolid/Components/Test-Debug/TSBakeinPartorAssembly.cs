...
{
    public class TSBakeinPartorAssembly : GH_Component, IGH_VariableParameterComponent
    {
        /// <summary>
        /// Initializes a new instance of the TSBake class.
        /// </summary>
        public TSBakeinPartorAssembly()
          : base("TopSolid Bake in assembly or part", "TSBakePartAssembly",
              "Bake Geometries with extended options in Part or Assembly",
              "TopSolid", "Test-Debug")
        {
        }
        ...
        {
            get { return new Guid("B11C335D-8AD2-4F51-8CC8-67D15F38DEB8"); }
        }
    }
}
