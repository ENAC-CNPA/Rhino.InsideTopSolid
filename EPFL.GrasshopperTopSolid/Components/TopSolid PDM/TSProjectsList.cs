...
namespace EPFL.GrasshopperTopSolid.Components.TopSolid_PDM
{
    ...
    public class TSProjectsList : GH_Component
    {
        /// <summary>
        ...
        public override void CreateAttributes()
        {
            ...
            m_attributes = new DropDownUIAttributes(this, FunctionToSetSelectedContent, dropdowncontents, selections, spacerDescriptionText);
        }
        ...
        {
            get { return new Guid("3a915cb5-904a-41c7-90c5-ccc390ec6abd"); }
        }
    }
